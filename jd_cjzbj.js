...
活动地址：https://anmp.jd.com/babelDiy/Zeus/2ehCdA8wRGaWgZ6movLN8edpEPCw/index.html
 */

const $ = new Env('超级值直播间浏览赢京豆抽京豆');
...
!(async () => {
  ...
  console.log('超级值直播间浏览赢京豆\n' +
      '活动时间：2021-8-5至2021-8-31\n' +
      '活动地址：https://anmp.jd.com/babelDiy/Zeus/3a2HFxtmYidKLRjeygmkZGPnMaR/index.html');
  for (let i = 0; i < cookiesArr.length; i++) {
    if (cookiesArr[i]) {
      ...
      try {
        await jdMh('https://anmp.jd.com/babelDiy/Zeus/36U1tDEAMdQHqc7JL9fEZ4Tuw4db/index.html?sid=f1449f152bcc78fb81be474cab82e24w&un_area=8_560_50820_61207&isShare=true&_ts=1640088361994&utm_source=iosapp&utm_medium=appshare&utm_campaign=t_335139774&utm_term=Wxfriends&ad_od=share&utm_user=plusmember')
      } catch (e) {
        $.logErr(e)
      }
    }
